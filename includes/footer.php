          ...
          <div class="container">
              <div
                  ...
                  <div
                      ...
                      <span
                          class="d-block text-base-color fs-15 ls-1px mb-5px text-uppercase fw-600">Office Address</span>
                ...
                event.ritualsbyritu@gmail.com -->
                  ...
                  <div
                      ...
                      <span
                          class="d-block text-base-color fs-15 ls-1px mb-5px text-uppercase fw-600">Connect With Us</span>
                      <a href="tel:+91 93017 38925" class="text-black lh-30">+91 93017 38925</a><br />
                      <a href="mailto:event.ritualsbyritu@gmail.com" class="text-black">event.ritualsbyritu@gmail.com</a>
                  </div>
                  <!-- end footer column -->
                  <!-- start footer column -->
                  <!-- <div
              ...
              /></a>
                  ...
                  <div
                      ...
                      <span
                          class="d-block text-base-color fs-15 ls-1px mb-10px text-uppercase fw-600">Follow Us</span>
              ...
              <div class="col instafeed-grid md-mb-30px xs-mb-15px">
                  <figure class="border-radius-0px">
                      <a href="https://www.instagram.com" target="_blank"><img
                              ...
                              class="insta-image"
                              alt="" /><span class="insta-icon"><i class="fa-brands fa-instagram"></i></span></a>
                  </figure>
              </div>
              <div class="col instafeed-grid md-mb-30px xs-mb-15px">
                  <figure class="border-radius-0px">
              ...
              <div class="absolute-middle-center z-index-1 w-auto">
                  <a
                      ...
                      <span>
                          ...
                          <span class="btn-double-text" data-text="Follow Rituals By Ritu">Follow Rituals By Ritu</span>
                      </span>
                  </a>
              </div>
          </div>
              ...
              <div
                  ...
                  <p>
                      ...
                      <a
                          ...
                          target="_blank"
                          class="text-decoration-line-bottom text-dark-gray fw-500">DigIN Media
                      </a>
                  </p>
              </div>
          </div>
