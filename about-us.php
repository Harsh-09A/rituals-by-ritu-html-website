...
<?php
$page_title = "About Us | Rituals By Ritu";
    ...
    <div class="container">
      ...
      <!-- <div class="row justify-content-center">
          <div
            ...
            <h5
              class="alt-font text-dark-gray mb-4 xs-mb-30px w-90 xl-w-100 mx-auto">
              We love what we do. The owners were married here and generations of
              their family have loved and still live here.
            </h5>
            <div class="row row-cols-1 row-cols-sm-3">
              <div class="col xs-mb-30px">
                <h2 class="fs-65 text-dark-gray mb-0 fw-700">248</h2>
                <span class="fs-19 fw-500 text-dark-gray">Our Services</span>
              </div>
              <div class="col xs-mb-30px">
                <h2 class="fs-65 text-dark-gray mb-0 fw-700">146</h2>
                <span class="fs-19 fw-500 text-dark-gray">Trained staff</span>
              </div>
              <div class="col">
                <h2 class="fs-65 text-dark-gray mb-0 fw-700">89%</h2>
                <span class="fs-19 fw-500 text-dark-gray">Good feedbacks</span>
              </div>
            </div>
          </div>
        </div> -->
